...
const Bio = {
  ...
  roles: ['Desarrollador Full Stack', 'Desarrollador Backend', 'Programador'],
  description:
    `Soy una persona motivada y versátil,
     siempre dispuesta a enfrentar nuevos desafíos. Con una pasión por aprender, estoy comprometido a crecer de una manera integral.
...
const experiences = [
  ...
  },
  {
    ...
    desc: 'Realicé análisis y manipulación de datos, desarrollando soluciones con tecnologías como .Net Core, Vue.js, Odoo y Python. También trabajé en la creación de warehouses y el uso de cubos OLAP con SQL Server Analysis Services para mejorar la toma de decisiones empresariales.',
...
const education = [
  ...
  },
  {
    ...
    date: 'Enero 2015 - Octubre 2019',
    grade: 'Bachillerato',
    desc: 'Complete el grado de bachillerato orientado a la computacion en el colegio Loyola',
    degree: '',
  },
];
...
const projects = [
  {
    ...
    description:
      'Un dia me consulte a mi mismo, ¿como se veria el sistema solar en 3D? y decidi crear esta aplicacion web que muestra el sistema solar en 3D utilizando React y Three.js.',
    image: 'space.webp',
...
const constants: Constants = { Bio, courses, education, experiences, projects, skills, lang: 'es' };
