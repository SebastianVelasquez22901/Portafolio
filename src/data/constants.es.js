export const Bio = {
  ...
  description:
    `Soy una persona motivada y versátil,
     siempre dispuesta a enfrentar nuevos desafíos. Con una pasión por aprender, estoy comprometido a crecer de una manera intregral.
...
export const skills = [
  {
    ...
    skills: [
      ...
      {
        "name": "Vue Js",
        "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Vue.js_Logo_2.svg/3840px-Vue.js_Logo_2.svg.png"
      }
    ],
  },
  {
    ...
    skills: [
      ...
      {
        "name": "Sql Server",
        "image": "https://img.icons8.com/color/600/microsoft-sql-server.png"
      }
    ...
    skills: [
      {
        name: "Git",
        image:
          "https://miro.medium.com/0*5g3mp6zgIoqprOgV.png",
      },
      {
        name: "GitHub",
        image:
      ...
      },
      {
        name: "Namecheap",
        image:
          "https://images.icon-icons.com/2407/PNG/512/namecheap_icon_146138.png",
      },
      {
        name: "VS Code",
        image:
      ...
      {
        name: "FTP",
        image: "https://cdn-icons-png.freepik.com/256/13983/13983127.png?semt=ais_white_label"
      },
      {
        name: "Odoo",
        image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTE7uExqWdSgzIRTVz-mieoSY3jPALVxBVzwQ&s"
      },
    ],
  },
];
...
export const education = [
  ...
  },
  {
    ...
    grade: "Bachillerato",
    desc: "Complete el grado de bachillerato orientado a la comptuacion en el colegio Loyola",
    degree: "",
  },
];
